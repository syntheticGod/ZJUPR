...
public class KDJ_BasePanel extends JPanel {
	 ...
	 class Chart_ImgPanel extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			for(int i=0;i<list1.size()-1;i++){
				KDJVO temp1=list1.get(i);
				KDJVO temp2=list1.get(i+1);
				double Shoushu1=Double.parseDouble(temp1.getK());
				double Shoushu2=Double.parseDouble(temp2.getK());
				int x1=(int)(1+i*18);
			...
			for(int i=0;i<list1.size()-1;i++){
				KDJVO temp1=list1.get(i);
				KDJVO temp2=list1.get(i+1);
				double Shoushu1=Double.parseDouble(temp1.getD());
				double Shoushu2=Double.parseDouble(temp2.getD());
				int x1=(int)(1+i*18);
				int y1=(int)(515-(Shoushu1-datamin)*perXiangSu);
				int x2=(int)(19+i*18);
				int y2=(int)(515-(Shoushu2-datamin)*perXiangSu);
			...
			for(int i=0;i<list1.size()-1;i++){
				KDJVO temp1=list1.get(i);
				KDJVO temp2=list1.get(i+1);
				double Shoushu1=Double.parseDouble(temp1.getJ());
				double Shoushu2=Double.parseDouble(temp2.getJ());
				int x1=(int)(1+i*18);
				int y1=(int)(515-(Shoushu1-datamin)*perXiangSu);
				int x2=(int)(19+i*18);
				int y2=(int)(515-(Shoushu2-datamin)*perXiangSu);
	 ...
	 class Chart_LocPanel extends JPanel{
		 ...
		 Chart_LocPanel(){
				...
				public void mouseClicked(MouseEvent e) {
					...
					KDJVO temp1=list1.get(selected);
					double data1=Double.parseDouble(temp1.getK());
					KDJVO temp2=list1.get(selected);
					double data2=Double.parseDouble(temp2.getD());
					KDJVO temp3=list1.get(selected);
					double data3=Double.parseDouble(temp3.getJ());
						...
						KDJ_BasePanel.this.setInfo(selected);
	...
	public void DataInit(String numOfStock,String date){
		...
		try {
			list1=bl.ComputeKDJ(numOfStock,51, 12,date);
		...
		for(int i=0;i<50;i++){
			KDJVO tempVO1=list1.get(i);
			
			double Data1=Double.parseDouble(tempVO1.getK());
			double Data2=Double.parseDouble(tempVO1.getD());
			double Data3=Double.parseDouble(tempVO1.getJ());
			if(i!=0){
	...
	void setInfo(int select){
		...
		KDJVO tempVO1=list1.get(select);
...
//		String Feestr = df.format(Fee);
		...
		LB1.setText("K："+tempVO1.getK());
		LB2.setText("D："+tempVO1.getD());
		LB3.setText("J："+tempVO1.getJ());
	}
	void LocChartReboot(){
		xLoc=2000;
		yLoc1=2000;
