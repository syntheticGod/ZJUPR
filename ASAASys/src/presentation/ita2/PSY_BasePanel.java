...
public class PSY_BasePanel extends JPanel {
	 ...
	 class Chart_ImgPanel extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			for(int i=0;i<list1.size()-1;i++){
				PSYVO temp1=list1.get(i);
				PSYVO temp2=list1.get(i+1);
	 ...
	 class Chart_LocPanel extends JPanel{
		 ...
		 Chart_LocPanel(){
				...
				public void mouseClicked(MouseEvent e) {
					...
					PSYVO temp1=list1.get(selected);
					double data1=Double.parseDouble(temp1.getData());
						...
						PSY_BasePanel.this.setInfo(selected);
	...
	public PSY_BasePanel() {
       ...
       JLabel lblbias = new JLabel("心理线(PSY)");
	...
	public void DataInit(String numOfStock,String date){
		...
		try {
			list1=bl.ComputePSY(numOfStocks, date, 50);
	...
	public void labelInit(){
		...
		label_9.setText(list1.get(20).getDate());
		label_11.setText(list1.get(30).getDate());
		label_10.setText(list1.get(40).getDate());
	}
	...
	void setInfo(int select){
		...
		PSYVO tempVO1=list1.get(select);
...
//		String Feestr = df.format(Fee);
		...
		LB1.setText("PSY："+tempVO1.getData()+"%");
