...
public class Atr_BasePanel extends JPanel {
	 ...
	 class Chart_ImgPanel extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			for(int i=0;i<list1.size()-1;i++){
				AtrVO temp1=list1.get(i);
				AtrVO temp2=list1.get(i+1);
				double Shoushu1=Double.parseDouble(temp1.getAtrnum());
				double Shoushu2=Double.parseDouble(temp2.getAtrnum());
				int x1=(int)(1+i*18);
	 ...
	 class Chart_LocPanel extends JPanel{
		 ...
		 Chart_LocPanel(){
				...
				public void mouseClicked(MouseEvent e) {
					...
					AtrVO temp1=list1.get(selected);
					double data1=Double.parseDouble(temp1.getAtrnum());
						...
						Atr_BasePanel.this.setInfo(selected);
	...
	public Atr_BasePanel() {
       ...
       JLabel lblbias = new JLabel("均幅指标(Atr)");
	...
	public void DataInit(String numOfStock,String date){
		...
		try {
			list1=bl.getAtr(numOfStock, 50, date);
		...
		for(int i=0;i<50;i++){
			AtrVO tempVO1=list1.get(i);
			
			double Data1=Double.parseDouble(tempVO1.getAtrnum());
	...
	void setInfo(int select){
		...
		AtrVO tempVO1=list1.get(select);
...
//		String Feestr = df.format(Fee);
		...
		LB1.setText("Atr："+tempVO1.getAtrnum());
